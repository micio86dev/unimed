...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Righe di traduzione per la validazione
    |--------------------------------------------------------------------------
    |
    | Le righe seguenti contengono i messaggi di errore predefiniti usati dalla
    | classe di validazione. Alcune regole hanno più varianti (es. le regole
    | sulla dimensione). Sentiti libero di modificare i messaggi.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Il valore :attribute è comparso in una violazione di dati. Scegli un :attribute diverso.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Righe di traduzione personalizzate
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Nomi leggibili degli attributi
    |--------------------------------------------------------------------------
    */
